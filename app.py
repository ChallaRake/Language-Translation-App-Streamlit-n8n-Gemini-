...
# if st.button("Submit"):
#     if text:
#         response = requests.post(url="https://raghu1010.app.n8n.cloud/webhook/bc95ff95-2880-4133-adbe-3c1ae89d6a85",json={"text":text})
        ...
        with st.spinner('🔄 Translating...'):
            try:
                ...
                response = requests.post(
                    url="https://raghu1010.app.n8n.cloud/webhook/bc95ff95-2880-4133-adbe-3c1ae89d6a85",
                    json=payload
                )
